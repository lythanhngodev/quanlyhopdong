<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="quanlycv.aspx.cs" Inherits="quanlyhopdong.quanly.quanlycv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content container-fluid">
        <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
            <h4 style="margin:0">QUẢN LÝ CV</h4>
            ...
            <div class="toolbar" id="divToolLuuQuyLai" style="display: none;">
                <button id="btnLamLai" class="btn btn-default" type="button">
                    <i class="ace-icon fa fa-recycle bigger-110"></i>
                    <span class="hidden-320">Làm lại</span>
                </button>
        ...
        <div class="col-xs-12" id="divload" style="display:none;">
            <div id="div1">
                <div class="col-xs-12">
                    <div class="row" style="padding-bottom: 2px; padding-top: 5px">
                        <div class="col-md-8" style="padding: 0;">
                            <input type="text" name="name" value="" id="txtTuNgay" class="form-control customInput" placeholder="dd/MM/yyyy" />&ensp;&ensp;
                            <input type="text" name="name" value="" id="txtDenNgay" class="form-control customInput" style="margin-left:4px;" placeholder="dd/MM/yyyy" />
                            <button class="btn btn-warning btn-sm" onclick="XuaExcelCV('1');return false;" ><i class="fa fa-file-excel-o" aria-hidden="true"></i>&ensp;Xuất Excel</button>
                            <button class="btn btn-warning btn-sm" onclick="XuaExcelCV('2');return false;" ><i class="fa fa-file-excel-o" aria-hidden="true"></i>&ensp;Xuất Excel tất cả</button>
                        </div>
                ...
                <div>
                    <cc1:Grid ID="Grid1" runat="server" FolderStyle="~/App_Themes/Styles/style_7" AllowPaging="true" FilterType="ProgrammaticOnly"
                        PageSizeOptions="15,50,150,200,500,1000,-1" PageSize="14" AutoGenerateColumns="false" AllowFiltering="true"
            ...
            <div id="div2" style="display:none;">
                <div class="col-xs-12">
                    ...
                    <fieldset id="khungNhapCV" style="border: 1px solid #DBDBE1; margin: 0;border-radius: 20px;">
                        ...
                        <div class="row" style="padding-bottom: 5px">
                            <div class="col-md-4">
                                ...
                                <div class="col-md-8" style="padding-left: 6px;">
                                    <input class="form-control input-sm" type="text" id="txtMaCC" placeholder="Nhập MCC">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-8" style="padding-left: 6px;">
                                    <input class="form-control input-sm" type="text" id="txtPhanXuong" placeholder="Nhập phân xưởng">
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding-bottom: 5px">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-8" style="padding-left: 6px;">
                                    <input class="form-control input-sm" type="text" id="txtSoDienThoai" placeholder="Nhập số điện thoại">
                                </div>
                            </div>
                        </div>
                        <div class="row" style="padding-bottom: 5px">
                            ...
                            <div class="col-md-4">
                                <div class="col-md-4">
                                    <label>Người GT</label>
                                </div>
                                <div class="col-md-8" style="padding-left: 6px;">
                                    <input class="form-control input-sm" type="text" id="txtNguoiGioiThieu" placeholder="Nhập người giới thiệu">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="col-md-4">
                        ...
                        <div class="row" style="padding-bottom: 5px">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-9" style="padding-left: 6px;">
                                    <input class="form-control input-sm" type="text" id="txtThamNien" placeholder="Nhập thâm niên">
                                </div>
                            </div>
                        </div>
                        <input type="hidden" id="txtHdMaCV" />
                        <br />
                    </fieldse>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" style="padding-bottom: 2px">
                            <div class="col-md-12">
                                <center>Xuất file Excel thành công có thể tải</center>
                                <center><a href="" id="linkExcel" class="btn btn-success btn-sm"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&ensp;Tại đây</a></center>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../Scripts/quanly/quanlycv.js"></script>
</asp:Content>
